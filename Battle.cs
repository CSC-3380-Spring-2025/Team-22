...
public partial class Battle : Node2D
{
	...
	public override void _Ready() {
		//Stops main menu music when battle scene starts
		var menu_music = GetNode<AudioStreamPlayer>("/root/MainMenuMusic");
		//var battle_music: AudioStreamPlayer = $battle_music as AudioStreamPlayer
		menu_music?.Stop();
		//Starts battle scene music 
		var _battle_music = GetNode<AudioStreamPlayer>("battle_music");
		_battle_music?.Play();
